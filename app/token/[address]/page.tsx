...
function scoreFactors(
  death: AutopsyResponse["death"],
  overview: AutopsyResponse["overview"]
) {
  return [
    {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-gothic text-4xl text-white">${symbol}</h1>
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-5 space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm">
          {[
            ...
            {
              label: "24h Change",
              value: `${overview.priceChange24hPercent?.toFixed(1) ?? "—"}%`,
            },
            {
              label: "Market Cap",
              value: overview.marketCap ? fmt(overview.marketCap) : "—",
            },
          ].map((m) => (
            <div key={m.label}>
